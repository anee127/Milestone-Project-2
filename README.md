...
- There was previously a bug in the code where the matched cards would flip back over when clicked. The end modal message would also appear even when not all cards had been matched. This has been fixed by locking the cards in place when matched.
# Credits
### Content
